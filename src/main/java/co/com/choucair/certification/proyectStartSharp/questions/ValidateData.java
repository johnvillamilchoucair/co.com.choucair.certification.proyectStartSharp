...
public class ValidateData implements Question<Boolean> {
    ...
    public ValidateData(ContactLoombokData contactLoombokData) {
        this.contactLoombokData = contactLoombokData;
    }

    public static ValidateData AfterSearching(ContactLoombokData contactLoombokData){
        return new ValidateData(contactLoombokData);
    }
    ...
    public Boolean answeredBy(Actor actor){
        ...
        String typeView = contactLoombokData.getTypeView();
        ...
        boolean isValid = (title != null && !title.isEmpty()) && title.equals(findingTitleOnPage) &&
